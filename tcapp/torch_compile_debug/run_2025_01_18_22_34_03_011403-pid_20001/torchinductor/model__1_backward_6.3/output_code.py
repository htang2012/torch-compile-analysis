...
cpp_fused__log_softmax_backward_data_0 = async_compile.cpp_pybinding(['const float*', 'const float*', 'float*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmp_6kzlk6x/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
...
cpp_fused_native_dropout_backward_sum_threshold_backward_1 = async_compile.cpp_pybinding(['float*', 'const float*', 'const bool*', 'const bool*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmp_6kzlk6x/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
        ...
        {
            {
                float tmp_acc0 = 0;
                at::vec::Vectorized<float> tmp_acc0_vec = at::vec::Vectorized<float>(0);
                for(int64_t x1=static_cast<int64_t>(0L); x1<static_cast<int64_t>(ks0); x1+=static_cast<int64_t>(1L))
                {
...
cpp_fused_convolution_backward_max_pool2d_with_indices_max_pool2d_with_indices_backward_native_dropout_backward_sum_threshold_backward_2 = async_compile.cpp_pybinding(['float*', 'float*', 'const float*', 'const bool*', 'const int8_t*', 'const float*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmp_6kzlk6x/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
extern "C"  void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       const float* in_ptr0,
                       ...
                       const int64_t ks0)
{
    ...
    #pragma omp parallel num_threads(4)
    {
        ...
        {
            #pragma omp for
            for(int64_t x0=static_cast<int64_t>(0L); x0<static_cast<int64_t>(9216L*ks0); x0+=static_cast<int64_t>(8L))
            {
...
cpp_fused_convolution_backward_threshold_backward_3 = async_compile.cpp_pybinding(['float*', 'const float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmp_6kzlk6x/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
extern "C"  void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const int64_t ks0)
{
    #pragma omp parallel num_threads(4)
    {
        ...
        {
            #pragma omp for
            for(int64_t x0=static_cast<int64_t>(0L); x0<static_cast<int64_t>(21632L*ks0); x0+=static_cast<int64_t>(8L))
            {
...
def call(args):
    primals_3, primals_1, primals_4, primals_5, relu, relu_1, getitem_1, gt, view, gt_1, mul_34, sub_18, permute_2, le, permute_6, tangents_1 = args
    args.clear()
    s0 = primals_3
    assert_size_stride(primals_1, (32, 1, 3, 3), (9, 9, 3, 1))
    assert_size_stride(primals_4, (s0, 1, 28, 28), (784, 784, 28, 1))
    assert_size_stride(primals_5, (64, 32, 3, 3), (288, 1, 96, 32))
    assert_size_stride(relu, (s0, 32, 26, 26), (21632, 1, 832, 32))
    assert_size_stride(relu_1, (s0, 64, 24, 24), (36864, 1, 1536, 64))
    assert_size_stride(getitem_1, (s0, 64, 12, 12), (9216, 1, 768, 64))
    assert_size_stride(gt, (s0, 64, 12, 12), (9216, 144, 12, 1))
    assert_size_stride(view, (s0, 9216), (9216, 1))
    assert_size_stride(gt_1, (s0, 128), (128, 1))
    assert_size_stride(mul_34, (s0, 128), (128, 1))
    assert_size_stride(sub_18, (s0, 10), (10, 1))
    assert_size_stride(permute_2, (10, 128), (128, 1))
    assert_size_stride(le, (s0, 128), (128, 1))
    assert_size_stride(permute_6, (128, 9216), (9216, 1))
    assert_size_stride(tangents_1, (s0, 10), (10, 1))
    buf0 = empty_strided_cpu((s0, 1), (1, s0), torch.float32)
    buf1 = empty_strided_cpu((s0, 10), (10, 1), torch.float32)
    cpp_fused__log_softmax_backward_data_0(tangents_1, sub_18, buf0, buf1, s0)
    del buf0
    del sub_18
    del tangents_1
    buf2 = empty_strided_cpu((s0, 128), (128, 1), torch.float32)
    ...
    # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf1, (10, s0), (1, 10), 0), mul_34, out=buf3)
    del mul_34
    buf4 = empty_strided_cpu((1, 10), (10, 1), torch.float32)
    buf5 = buf2; del buf2  # reuse
    cpp_fused_native_dropout_backward_sum_threshold_backward_1(buf5, buf1, le, gt_1, buf4, s0)
    del buf1
    del gt_1
    del le
    buf6 = empty_strided_cpu((s0, 9216), (9216, 1), torch.float32)
    # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf5, permute_6, out=buf6)
    del permute_6
    buf7 = empty_strided_cpu((128, 9216), (9216, 1), torch.float32)
    # Topologically Sorted Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (128, s0), (1, 128), 0), view, out=buf7)
    del view
    buf8 = empty_strided_cpu((1, 128), (128, 1), torch.float32)
    buf9 = reinterpret_tensor(buf6, (s0, 64, 12, 12), (9216, 144, 12, 1), 0); del buf6  # reuse
    buf10 = empty_strided_cpu((s0, 64, 24, 24), (36864, 1, 1536, 64), torch.float32)
    buf11 = buf10; del buf10  # reuse
    cpp_fused_convolution_backward_max_pool2d_with_indices_max_pool2d_with_indices_backward_native_dropout_backward_sum_threshold_backward_2(buf9, buf11, buf5, gt, getitem_1, relu_1, buf8, s0)
    del buf5
    del buf9
    del getitem_1
    del gt
    ...
    buf12 = torch.ops.aten.convolution_backward.default(buf11, relu, primals_5, [64], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True])
    del buf11
    del primals_5
    buf13 = buf12[0]
    buf14 = buf12[1]
    ...
    cpp_fused_convolution_backward_threshold_backward_3(buf16, relu, s0)
    del relu
    # Topologically Sorted Source Nodes: [], Original ATen: [aten.threshold_backward, aten.convolution_backward]
    buf17 = torch.ops.aten.convolution_backward.default(buf16, primals_4, primals_1, [32], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [False, True, True])
    del buf16
    del primals_1
    del primals_4
    buf18 = buf17[1]
    buf19 = buf17[2]
    return (buf18, buf19, None, None, buf14, buf15, buf7, reinterpret_tensor(buf8, (128, ), (1, ), 0), buf3, reinterpret_tensor(buf4, (10, ), (1, ), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_4 = rand_strided((32, 1, 28, 28), (784, 784, 28, 1), device='cpu', dtype=torch.float32)
    primals_5 = rand_strided((64, 32, 3, 3), (288, 1, 96, 32), device='cpu', dtype=torch.float32)
    relu = rand_strided((32, 32, 26, 26), (21632, 1, 832, 32), device='cpu', dtype=torch.float32)
    relu_1 = rand_strided((32, 64, 24, 24), (36864, 1, 1536, 64), device='cpu', dtype=torch.float32)
    getitem_1 = rand_strided((32, 64, 12, 12), (9216, 1, 768, 64), device='cpu', dtype=torch.int8)
    gt = rand_strided((32, 64, 12, 12), (9216, 144, 12, 1), device='cpu', dtype=torch.bool)
    view = rand_strided((32, 9216), (9216, 1), device='cpu', dtype=torch.float32)
    gt_1 = rand_strided((32, 128), (128, 1), device='cpu', dtype=torch.bool)
    mul_34 = rand_strided((32, 128), (128, 1), device='cpu', dtype=torch.float32)
    sub_18 = rand_strided((32, 10), (10, 1), device='cpu', dtype=torch.float32)
    permute_2 = rand_strided((10, 128), (128, 1), device='cpu', dtype=torch.float32)
    le = rand_strided((32, 128), (128, 1), device='cpu', dtype=torch.bool)
    permute_6 = rand_strided((128, 9216), (9216, 1), device='cpu', dtype=torch.float32)
    tangents_1 = rand_strided((32, 10), (10, 1), device='cpu', dtype=torch.float32)
    fn = lambda: call([primals_3, primals_1, primals_4, primals_5, relu, relu_1, getitem_1, gt, view, gt_1, mul_34, sub_18, permute_2, le, permute_6, tangents_1])
