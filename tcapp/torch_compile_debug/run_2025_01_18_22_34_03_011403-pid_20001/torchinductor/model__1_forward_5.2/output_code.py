...
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
...
cpp_fused_relu_1 = async_compile.cpp_pybinding(['const float*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
extern "C"  void kernel(const float* in_ptr0,
                       float* out_ptr0,
                       const int64_t ks0)
...
cpp_fused_max_pool2d_with_indices_relu_2 = async_compile.cpp_pybinding(['float*', 'int8_t*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
                       ...
                       const int64_t ks0)
{
    #pragma omp parallel num_threads(4)
    {
        ...
        {
            #pragma omp for
            for(int64_t x0=static_cast<int64_t>(0L); x0<static_cast<int64_t>(36864L*ks0); x0+=static_cast<int64_t>(8L))
            {
        ...
        {
            #pragma omp for
            for(int64_t x0=static_cast<int64_t>(0L); x0<static_cast<int64_t>(12L*ks0); x0+=static_cast<int64_t>(1L))
            {
                #pragma GCC ivdep
...
cpp_fused_max_pool2d_with_indices_native_dropout_3 = async_compile.cpp_pybinding(['const int64_t*', 'const float*', 'bool*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
...
cpp_fused_native_dropout_relu_threshold_backward_4 = async_compile.cpp_pybinding(['const int64_t*', 'const float*', 'bool*', 'float*', 'bool*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
extern "C"  void kernel(const int64_t* in_ptr0,
                       const float* in_ptr1,
                       bool* out_ptr1,
...
cpp_fused__log_softmax_5 = async_compile.cpp_pybinding(['const float*', 'float*', 'float*', 'float*', 'const int64_t'], '''
#include "/tmp/torchinductor_root/tmpx575qxgr/vu/cvuvp4i7roujum4xemrfwnb3t4c5t3r3mihr4b7iegh6tcqvdg43.h"
extern "C"  void kernel(const float* in_ptr0,
                       float* out_ptr0,
                       float* out_ptr1,
...
def call(args):
    ...
    assert_size_stride(primals_5, (64, 32, 3, 3), (288, 9, 3, 1))
    assert_size_stride(primals_6, (64, ), (1, ))
    assert_size_stride(primals_7, (128, 9216), (9216, 1))
    assert_size_stride(primals_8, (128, ), (1, ))
    assert_size_stride(primals_9, (10, 128), (128, 1))
    assert_size_stride(primals_10, (10, ), (1, ))
    buf0 = empty_strided_cpu((64, 32, 3, 3), (288, 1, 96, 32), torch.float32)
    cpp_fused_0(primals_5, buf0)
    del primals_5
    # Topologically Sorted Source Nodes: [x], Original ATen: [aten.convolution]
    buf1 = extern_kernels.convolution(primals_4, primals_1, primals_2, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1)
    assert_size_stride(buf1, (s0, 32, 26, 26), (21632, 676, 26, 1))
    del primals_2
    buf2 = empty_strided_cpu((s0, 32, 26, 26), (21632, 1, 832, 32), torch.float32)
    cpp_fused_relu_1(buf1, buf2, s0)
    del buf1
    # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten.convolution]
    buf3 = extern_kernels.convolution(buf2, buf0, primals_6, stride=(1, 1), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1)
    assert_size_stride(buf3, (s0, 64, 24, 24), (36864, 1, 1536, 64))
    del primals_6
    buf4 = buf3; del buf3  # reuse
    buf5 = empty_strided_cpu((s0, 64, 12, 12), (9216, 1, 768, 64), torch.int8)
    cpp_fused_max_pool2d_with_indices_relu_2(buf4, buf5, s0)
    buf6 = empty_strided_cpu((2, ), (1, ), torch.int64)
    # Topologically Sorted Source Nodes: [], Original ATen: []
    aten.randint.low_out(-9223372036854775808, 9223372036854775807, [2], out=buf6)
    buf8 = empty_strided_cpu((s0, 64, 12, 12), (9216, 144, 12, 1), torch.bool)
    buf9 = empty_strided_cpu((s0, 64, 12, 12), (9216, 144, 12, 1), torch.float32)
    cpp_fused_max_pool2d_with_indices_native_dropout_3(buf6, buf4, buf8, buf9, s0)
    buf10 = empty_strided_cpu((s0, 128), (128, 1), torch.float32)
    # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_8, reinterpret_tensor(buf9, (s0, 9216), (9216, 1), 0), reinterpret_tensor(primals_7, (9216, 128), (1, 9216), 0), alpha=1, beta=1, out=buf10)
    del primals_8
    buf12 = empty_strided_cpu((s0, 128), (128, 1), torch.bool)
    buf13 = empty_strided_cpu((s0, 128), (128, 1), torch.float32)
    buf18 = empty_strided_cpu((s0, 128), (128, 1), torch.bool)
    cpp_fused_native_dropout_relu_threshold_backward_4(buf6, buf10, buf12, buf13, buf18, s0)
    del buf10
    del buf6
    buf14 = empty_strided_cpu((s0, 10), (10, 1), torch.float32)
    # Topologically Sorted Source Nodes: [x_10], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_10, buf13, reinterpret_tensor(primals_9, (128, 10), (1, 128), 0), alpha=1, beta=1, out=buf14)
    del primals_10
    buf15 = empty_strided_cpu((s0, 1), (1, s0), torch.float32)
    buf16 = empty_strided_cpu((s0, 1), (1, s0), torch.float32)
    buf17 = empty_strided_cpu((s0, 10), (10, 1), torch.float32)
    cpp_fused__log_softmax_5(buf14, buf15, buf16, buf17, s0)
    return (buf17, primals_1, primals_4, buf0, buf2, buf4, buf5, buf8, reinterpret_tensor(buf9, (s0, 9216), (9216, 1), 0), buf12, buf13, buf17, primals_9, buf18, primals_7, s0, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_5 = rand_strided((64, 32, 3, 3), (288, 9, 3, 1), device='cpu', dtype=torch.float32)
    primals_6 = rand_strided((64, ), (1, ), device='cpu', dtype=torch.float32)
    primals_7 = rand_strided((128, 9216), (9216, 1), device='cpu', dtype=torch.float32)
    primals_8 = rand_strided((128, ), (1, ), device='cpu', dtype=torch.float32)
    primals_9 = rand_strided((10, 128), (128, 1), device='cpu', dtype=torch.float32)
    primals_10 = rand_strided((10, ), (1, ), device='cpu', dtype=torch.float32)
